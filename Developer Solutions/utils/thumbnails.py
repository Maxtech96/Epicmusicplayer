# Power By @developersolutions
# Join @developerandsolutions For More Update
# Join @techfreaks9 For Hack
...
async def gen_thumb(videoid, user_id):
    ...
    try:
        ...
        draw.text((190, 650), f"Powered By: Developersolutions (@developersolutions)", (255, 255, 255), font=font)
        try:
            os.remove(f"cache/thumb{videoid}.png")
